...
const fetchDatas = () => {
  ...
  const fetchData = () => {
    fetch("http://localhost/peer_assesment/backend/get_pengelompokan.php")
      .then((res) => res.json())
      .then((json) => {
  ...
  const fetchMahasiswa = async (group: Pengelompokan) => {
    ...
    url.searchParams.append("id_matakuliah", group.id_matakuliah);
    url.searchParams.append("id_pengelompokan", group.id.toString());

...
// Validasi input
if ($id_asdos && $nama_asdos && $id_user && $no_telepon && $nip) {
    // Update tabel asdos
    $stmt = $koneksi->prepare("UPDATE asdos SET nama_asdos=?, id_user=?, no_telepon=?, nip=? WHERE id_asdos=?");
    $stmt->bind_param("sissi", $nama_asdos, $id_user, $no_telepon, $nip, $id_asdos);
